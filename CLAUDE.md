...
FRAPPE_VERSION=v15 ERPNEXT_VERSION=v15 docker buildx bake <target>
...
1. Copy `devcontainer-example` to `.devcontainer`
...
```bash
# Use installer script (inside dev container)
python installer.py  # See --help for options
```
